...
class PetConfig:
    ...
    PET_NAMES = ["Rocket", "Pebble", "Splash"]
    PET_DESCRIPTIONS = [    
                            ["Rocket, the adventurous and spirited raccoon, is ready for exciting journeys.",
                                "Care for Rocket's needs, play together, and watch their adventurous spirit soar."],
                            ["Pebble, the rockstar of resilience, adds a touch of glamour to your care routine.", 
                                "Create a rockin' environment, spend quality time, and witness Pebble's unwavering charm."],
                            ["Splash, the energetic and aquatic marvel, brings a wave of joy to your care routine.", 
